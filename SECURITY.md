...
**No Supabase SDK dependency** - we use URLSession's built-in WebSocket implementation for direct Supabase Realtime connections using the Phoenix protocol.
...
- ✅ Supabase Realtime for watch party sync (temporary, session-only)
