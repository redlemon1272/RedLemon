...
Terminating Process:   exc handler [36864]
...
114 RedLemon                      	       0x101e230a3 static RedLemonApp.$main() + 35 (RedLemonApp.swift:31)
115 RedLemon                      	       0x101e23129 RedLemon_main + 9
116 dyld                          	       0x10e6f552e start + 462
...
1   RedLemon                      	       0x101bf22c9 @nonobjc kevent(_:_:_:_:_:_:) + 9
2   RedLemon                      	       0x101bfc1ef closure #1 in static KQueue.kevent(kq:changelist:nchanges:eventlist:nevents:timeout:) + 95 (System.swift:911)
3   RedLemon                      	       0x101bfc844 partial apply for closure #1 in static KQueue.kevent(kq:changelist:nchanges:eventlist:nevents:timeout:) + 36
4   RedLemon                      	       0x101bf2f7b syscall<A>(blocking:where:_:) + 395 (System.swift:247)
5   RedLemon                      	       0x101bfc0e8 static KQueue.kevent(kq:changelist:nchanges:eventlist:nevents:timeout:) + 312 (System.swift:910)
6   RedLemon                      	       0x101bd8bb6 closure #1 in Selector.whenReady0(strategy:onLoopBegin:_:) + 230 (SelectorKqueue.swift:212)
7   RedLemon                      	       0x101bd9c1f partial apply for closure #1 in Selector.whenReady0(strategy:onLoopBegin:_:) + 15
8   RedLemon                      	       0x101bcaae3 Optional.withUnsafeOptionalPointer<A>(_:) + 467 (SelectorGeneric.swift:31)
9   RedLemon                      	       0x101bd73cd Selector.whenReady0(strategy:onLoopBegin:_:) + 1053 (SelectorKqueue.swift:211)
10  RedLemon                      	       0x101bd0cf4 Selector.whenReady(strategy:onLoopBegin:_:) + 100 (SelectorGeneric.swift:288)
11  RedLemon                      	       0x101bc55ae closure #2 in SelectableEventLoop.run() + 158 (SelectableEventLoop.swift:653)
12  RedLemon                      	       0x101bc89d4 partial apply for closure #2 in SelectableEventLoop.run() + 20
13  RedLemon                      	       0x101bbd562 closure #1 in withAutoReleasePool<A>(_:) + 34 (SelectableEventLoop.swift:27)
14  RedLemon                      	       0x101bbd5ac partial apply for closure #1 in withAutoReleasePool<A>(_:) + 28
15  libswiftObjectiveC.dylib      	    0x7ff82bc48e7c autoreleasepool<A>(invoking:) + 44
16  RedLemon                      	       0x101bbd509 withAutoReleasePool<A>(_:) + 57 (SelectableEventLoop.swift:26)
17  RedLemon                      	       0x101bc462f SelectableEventLoop.run() + 591 (SelectableEventLoop.swift:652)
18  RedLemon                      	       0x101b66348 static MultiThreadedEventLoopGroup.runTheLoop(thread:parentGroup:canEventLoopBeShutdownIndividually:selectorFactory:initializer:_:) + 856 (MultiThreadedEventLoopGroup.swift:93)
19  RedLemon                      	       0x101b66a9a closure #1 in static MultiThreadedEventLoopGroup.setupThreadAndEventLoop(name:parentGroup:selectorFactory:initializer:) + 282 (MultiThreadedEventLoopGroup.swift:111)
20  RedLemon                      	       0x101b6cd73 partial apply for closure #1 in static MultiThreadedEventLoopGroup.setupThreadAndEventLoop(name:parentGroup:selectorFactory:initializer:) + 51
21  RedLemon                      	       0x101bfcc3f thunk for @escaping @callee_guaranteed (@guaranteed NIOThread) -> () + 15
22  RedLemon                      	       0x101bff7af closure #1 in static ThreadOpsPosix.run(handle:args:detachThread:) + 1007 (ThreadPosix.swift:116)
23  RedLemon                      	       0x101bff869 @objc closure #1 in static ThreadOpsPosix.run(handle:args:detachThread:) + 9
...
3   RedLemon                      	       0x101b6f23f NIOThreadPool.process(identifier:) + 143 (NIOThreadPool.swift:186)
4   RedLemon                      	       0x101b7010e closure #3 in NIOThreadPool._start(threadNamePrefix:) + 222 (NIOThreadPool.swift:252)
5   RedLemon                      	       0x101bfcc3f thunk for @escaping @callee_guaranteed (@guaranteed NIOThread) -> () + 15
6   RedLemon                      	       0x101bff7af closure #1 in static ThreadOpsPosix.run(handle:args:detachThread:) + 1007 (ThreadPosix.swift:116)
7   RedLemon                      	       0x101bff869 @objc closure #1 in static ThreadOpsPosix.run(handle:args:detachThread:) + 9
...
Thread 0 crashed with X86 Thread State (64-bit):
  rax: 0x031dfff858953501  rbx: 0x00007f9e388c3f60  rcx: 0x0080000000000000  rdx: 0x0100000000000000
  rdi: 0x00007f9e388c3f60  rsi: 0x021dfff858953531  rbp: 0x00007ff7bf1925e0  rsp: 0x00007ff7bf192580
   r8: 0x0000000000000010   r9: 0x0f0f0f0f0f0f0f0f  r10: 0x00007ff858266d38  r11: 0x00007ff817b75c50
  r12: 0x00007ff7bf1925f0  r13: 0x00007f9e388c3f60  r14: 0x00007ff7bf192600  r15: 0x00007ff7bf192680
...
Binary Images:
    ...
    0x7ff819745000 -     0x7ff81a5d4fff com.apple.AppKit (6.9) <5dd484cf-ed6a-3633-b42e-6518aeecd5b9> /System/Library/Frameworks/AppKit.framework/Versions/C/AppKit
       0x100d68000 -        0x102d63fff com.redlemon.app (1.0.14) <9d8d6a59-5b23-3847-b067-c8f1800c55bb> /Users/USER/Desktop/*/RedLemon.app/Contents/MacOS/RedLemon
       0x10e6f0000 -        0x10e75bfff dyld (*) <eea022bb-a6ab-3cd1-8ac1-54ce8cfd3333> /usr/lib/dyld
...
Writable regions: Total=147.2M written=0K(0%) resident=0K(0%) swapped_out=0K(0%) unallocated=147.2M(100%)
...
{"app_name":"RedLemon","timestamp":"2025-12-07 18:59:54.00 -0500","app_version":"1.0.14","slice_uuid":"9d8d6a59-5b23-3847-b067-c8f1800c55bb","build_version":"14","platform":1,"bundleID":"com.redlemon.app","share_with_app_devs":0,"is_first_party":0,"bug_type":"309","os_version":"macOS 12.7.6 (21H1320)","incident_id":"C4F1E6A2-F477-4D01-A710-D4C7E39FB364","name":"RedLemon"}
{
  "uptime" : 33000,
  "procLaunch" : "2025-12-07 18:59:49.6575 -0500",
  "procRole" : "Foreground",
  "version" : 2,
  "userID" : 501,
  "deployVersion" : 210,
  "modelCode" : "MacBookPro12,1",
  "procStartAbsTime" : 33248056859185,
  "coalitionID" : 626,
  "osVersion" : {
    "train" : "macOS 12.7.6",
    "build" : "21H1320",
  ...
  "captureTime" : "2025-12-07 18:59:51.8378 -0500",
  "incident" : "C4F1E6A2-F477-4D01-A710-D4C7E39FB364",
  "bug_type" : "309",
  "pid" : 36864,
  "procExitAbsTime" : 33250198051462,
  "cpuType" : "X86-64",
  "procName" : "RedLemon",
  ...
  },
  {
    ...
    "size" : 33538048,
    "uuid" : "9d8d6a59-5b23-3847-b067-c8f1800c55bb",
    "path" : "\/Users\/USER\/Desktop\/*\/RedLemon.app\/Contents\/MacOS\/RedLemon",
    "name" : "RedLemon",
    "CFBundleVersion" : "14"
  },
