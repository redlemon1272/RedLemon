...
Terminating Process:   exc handler [38592]
...
119 RedLemon                      	       0x10f064063 static RedLemonApp.$main() + 35 (RedLemonApp.swift:31)
120 RedLemon                      	       0x10f0640e9 RedLemon_main + 9
121 dyld                          	       0x11f42c52e start + 462
...
1   RedLemon                      	       0x10ee33289 @nonobjc kevent(_:_:_:_:_:_:) + 9
2   RedLemon                      	       0x10ee3d1af closure #1 in static KQueue.kevent(kq:changelist:nchanges:eventlist:nevents:timeout:) + 95 (System.swift:911)
3   RedLemon                      	       0x10ee3d804 partial apply for closure #1 in static KQueue.kevent(kq:changelist:nchanges:eventlist:nevents:timeout:) + 36
4   RedLemon                      	       0x10ee33f3b syscall<A>(blocking:where:_:) + 395 (System.swift:247)
5   RedLemon                      	       0x10ee3d0a8 static KQueue.kevent(kq:changelist:nchanges:eventlist:nevents:timeout:) + 312 (System.swift:910)
6   RedLemon                      	       0x10ee19b76 closure #1 in Selector.whenReady0(strategy:onLoopBegin:_:) + 230 (SelectorKqueue.swift:212)
7   RedLemon                      	       0x10ee1abdf partial apply for closure #1 in Selector.whenReady0(strategy:onLoopBegin:_:) + 15
8   RedLemon                      	       0x10ee0baa3 Optional.withUnsafeOptionalPointer<A>(_:) + 467 (SelectorGeneric.swift:31)
9   RedLemon                      	       0x10ee1838d Selector.whenReady0(strategy:onLoopBegin:_:) + 1053 (SelectorKqueue.swift:211)
10  RedLemon                      	       0x10ee11cb4 Selector.whenReady(strategy:onLoopBegin:_:) + 100 (SelectorGeneric.swift:288)
11  RedLemon                      	       0x10ee0656e closure #2 in SelectableEventLoop.run() + 158 (SelectableEventLoop.swift:653)
12  RedLemon                      	       0x10ee09994 partial apply for closure #2 in SelectableEventLoop.run() + 20
13  RedLemon                      	       0x10edfe522 closure #1 in withAutoReleasePool<A>(_:) + 34 (SelectableEventLoop.swift:27)
14  RedLemon                      	       0x10edfe56c partial apply for closure #1 in withAutoReleasePool<A>(_:) + 28
15  libswiftObjectiveC.dylib      	    0x7ff82bc48e7c autoreleasepool<A>(invoking:) + 44
16  RedLemon                      	       0x10edfe4c9 withAutoReleasePool<A>(_:) + 57 (SelectableEventLoop.swift:26)
17  RedLemon                      	       0x10ee055ef SelectableEventLoop.run() + 591 (SelectableEventLoop.swift:652)
18  RedLemon                      	       0x10eda7308 static MultiThreadedEventLoopGroup.runTheLoop(thread:parentGroup:canEventLoopBeShutdownIndividually:selectorFactory:initializer:_:) + 856 (MultiThreadedEventLoopGroup.swift:93)
19  RedLemon                      	       0x10eda7a5a closure #1 in static MultiThreadedEventLoopGroup.setupThreadAndEventLoop(name:parentGroup:selectorFactory:initializer:) + 282 (MultiThreadedEventLoopGroup.swift:111)
20  RedLemon                      	       0x10edadd33 partial apply for closure #1 in static MultiThreadedEventLoopGroup.setupThreadAndEventLoop(name:parentGroup:selectorFactory:initializer:) + 51
21  RedLemon                      	       0x10ee3dbff thunk for @escaping @callee_guaranteed (@guaranteed NIOThread) -> () + 15
22  RedLemon                      	       0x10ee4076f closure #1 in static ThreadOpsPosix.run(handle:args:detachThread:) + 1007 (ThreadPosix.swift:116)
23  RedLemon                      	       0x10ee40829 @objc closure #1 in static ThreadOpsPosix.run(handle:args:detachThread:) + 9
...
3   RedLemon                      	       0x10edb01ff NIOThreadPool.process(identifier:) + 143 (NIOThreadPool.swift:186)
4   RedLemon                      	       0x10edb10ce closure #3 in NIOThreadPool._start(threadNamePrefix:) + 222 (NIOThreadPool.swift:252)
5   RedLemon                      	       0x10ee3dbff thunk for @escaping @callee_guaranteed (@guaranteed NIOThread) -> () + 15
6   RedLemon                      	       0x10ee4076f closure #1 in static ThreadOpsPosix.run(handle:args:detachThread:) + 1007 (ThreadPosix.swift:116)
7   RedLemon                      	       0x10ee40829 @objc closure #1 in static ThreadOpsPosix.run(handle:args:detachThread:) + 9
...
Thread 0 crashed with X86 Thread State (64-bit):
  rax: 0x031dfff858953501  rbx: 0x00007fea898abb10  rcx: 0x0080000000000000  rdx: 0x0100000000000000
  rdi: 0x00007fea898abb10  rsi: 0x021dfff858953531  rbp: 0x00007ff7b1f51350  rsp: 0x00007ff7b1f512f0
   r8: 0x0000000000000010   r9: 0x0f0f0f0f0f0f0f0f  r10: 0x00007ff858266d38  r11: 0x00007ff817b75c50
  r12: 0x00007ff7b1f51360  r13: 0x00007fea898abb10  r14: 0x00007ff7b1f51370  r15: 0x00007ff7b1f513f0
...
Binary Images:
    ...
    0x7ff819745000 -     0x7ff81a5d4fff com.apple.AppKit (6.9) <5dd484cf-ed6a-3633-b42e-6518aeecd5b9> /System/Library/Frameworks/AppKit.framework/Versions/C/AppKit
       0x10dfa9000 -        0x10ffa8fff com.redlemon.app (1.0.14) <2f489826-c3b6-3b3f-a97b-c903c01c8548> /Users/USER/Desktop/*/RedLemon.app/Contents/MacOS/RedLemon
       0x11f427000 -        0x11f492fff dyld (*) <eea022bb-a6ab-3cd1-8ac1-54ce8cfd3333> /usr/lib/dyld
...
Writable regions: Total=143.0M written=0K(0%) resident=0K(0%) swapped_out=0K(0%) unallocated=143.0M(100%)
...
{"app_name":"RedLemon","timestamp":"2025-12-07 19:20:16.00 -0500","app_version":"1.0.14","slice_uuid":"2f489826-c3b6-3b3f-a97b-c903c01c8548","build_version":"14","platform":1,"bundleID":"com.redlemon.app","share_with_app_devs":0,"is_first_party":0,"bug_type":"309","os_version":"macOS 12.7.6 (21H1320)","incident_id":"64C3BFD3-ED25-4443-8801-EFB57F06BF37","name":"RedLemon"}
{
  "uptime" : 34000,
  "procLaunch" : "2025-12-07 19:20:11.2216 -0500",
  "procRole" : "Background",
  "version" : 2,
  "userID" : 501,
  "deployVersion" : 210,
  "modelCode" : "MacBookPro12,1",
  "procStartAbsTime" : 34469326318935,
  "coalitionID" : 626,
  "osVersion" : {
    "train" : "macOS 12.7.6",
    "build" : "21H1320",
  ...
  "captureTime" : "2025-12-07 19:20:13.1267 -0500",
  "incident" : "64C3BFD3-ED25-4443-8801-EFB57F06BF37",
  "bug_type" : "309",
  "pid" : 38592,
  "procExitAbsTime" : 34471229216746,
  "cpuType" : "X86-64",
  "procName" : "RedLemon",
  ...
  },
  {
    ...
    "size" : 33554432,
    "uuid" : "2f489826-c3b6-3b3f-a97b-c903c01c8548",
    "path" : "\/Users\/USER\/Desktop\/*\/RedLemon.app\/Contents\/MacOS\/RedLemon",
    "name" : "RedLemon",
    "CFBundleVersion" : "14"
  },
