...
Terminating Process:   exc handler [19190]
...
94  HIToolbox                     	    0x7ff80f0e3213 ReceiveNextEventCommon + 283
...
103 RedLemon                      	       0x1097cab33 static RedLemonApp.$main() + 35 (RedLemonApp.swift:31)
104 RedLemon                      	       0x1097cabb9 RedLemon_main + 9
105 dyld                          	       0x110d9f52e start + 462
...
1   RedLemon                      	       0x1095a31c9 @nonobjc kevent(_:_:_:_:_:_:) + 9
2   RedLemon                      	       0x1095ad0ef closure #1 in static KQueue.kevent(kq:changelist:nchanges:eventlist:nevents:timeout:) + 95 (System.swift:911)
3   RedLemon                      	       0x1095ad744 partial apply for closure #1 in static KQueue.kevent(kq:changelist:nchanges:eventlist:nevents:timeout:) + 36
4   RedLemon                      	       0x1095a3e7b syscall<A>(blocking:where:_:) + 395 (System.swift:247)
5   RedLemon                      	       0x1095acfe8 static KQueue.kevent(kq:changelist:nchanges:eventlist:nevents:timeout:) + 312 (System.swift:910)
6   RedLemon                      	       0x109589ab6 closure #1 in Selector.whenReady0(strategy:onLoopBegin:_:) + 230 (SelectorKqueue.swift:212)
7   RedLemon                      	       0x10958ab1f partial apply for closure #1 in Selector.whenReady0(strategy:onLoopBegin:_:) + 15
8   RedLemon                      	       0x10957baa2 closure #1 in Optional.withUnsafeOptionalPointer<A>(_:) + 50 (SelectorGeneric.swift:28)
9   RedLemon                      	       0x10957baf7 partial apply for closure #1 in Optional.withUnsafeOptionalPointer<A>(_:) + 39
10  libswiftCore.dylib            	    0x7ff81394572c withUnsafePointer<A, B>(to:_:) + 12
11  RedLemon                      	       0x10957b96a Optional.withUnsafeOptionalPointer<A>(_:) + 346 (SelectorGeneric.swift:27)
12  RedLemon                      	       0x1095882cd Selector.whenReady0(strategy:onLoopBegin:_:) + 1053 (SelectorKqueue.swift:211)
13  RedLemon                      	       0x109581bf4 Selector.whenReady(strategy:onLoopBegin:_:) + 100 (SelectorGeneric.swift:288)
14  RedLemon                      	       0x1095764ae closure #2 in SelectableEventLoop.run() + 158 (SelectableEventLoop.swift:653)
15  RedLemon                      	       0x1095798d4 partial apply for closure #2 in SelectableEventLoop.run() + 20
16  RedLemon                      	       0x10956e462 closure #1 in withAutoReleasePool<A>(_:) + 34 (SelectableEventLoop.swift:27)
17  RedLemon                      	       0x10956e4ac partial apply for closure #1 in withAutoReleasePool<A>(_:) + 28
18  libswiftObjectiveC.dylib      	    0x7ff81b334e7c autoreleasepool<A>(invoking:) + 44
19  RedLemon                      	       0x10956e409 withAutoReleasePool<A>(_:) + 57 (SelectableEventLoop.swift:26)
20  RedLemon                      	       0x10957552f SelectableEventLoop.run() + 591 (SelectableEventLoop.swift:652)
21  RedLemon                      	       0x109517248 static MultiThreadedEventLoopGroup.runTheLoop(thread:parentGroup:canEventLoopBeShutdownIndividually:selectorFactory:initializer:_:) + 856 (MultiThreadedEventLoopGroup.swift:93)
22  RedLemon                      	       0x10951799a closure #1 in static MultiThreadedEventLoopGroup.setupThreadAndEventLoop(name:parentGroup:selectorFactory:initializer:) + 282 (MultiThreadedEventLoopGroup.swift:111)
23  RedLemon                      	       0x10951dc73 partial apply for closure #1 in static MultiThreadedEventLoopGroup.setupThreadAndEventLoop(name:parentGroup:selectorFactory:initializer:) + 51
24  RedLemon                      	       0x1095adb3f thunk for @escaping @callee_guaranteed (@guaranteed NIOThread) -> () + 15
25  RedLemon                      	       0x1095b06af closure #1 in static ThreadOpsPosix.run(handle:args:detachThread:) + 1007 (ThreadPosix.swift:116)
26  RedLemon                      	       0x1095b0769 @objc closure #1 in static ThreadOpsPosix.run(handle:args:detachThread:) + 9
...
3   RedLemon                      	       0x10952013f NIOThreadPool.process(identifier:) + 143 (NIOThreadPool.swift:186)
4   RedLemon                      	       0x10952100e closure #3 in NIOThreadPool._start(threadNamePrefix:) + 222 (NIOThreadPool.swift:252)
5   RedLemon                      	       0x1095adb3f thunk for @escaping @callee_guaranteed (@guaranteed NIOThread) -> () + 15
6   RedLemon                      	       0x1095b06af closure #1 in static ThreadOpsPosix.run(handle:args:detachThread:) + 1007 (ThreadPosix.swift:116)
7   RedLemon                      	       0x1095b0769 @objc closure #1 in static ThreadOpsPosix.run(handle:args:detachThread:) + 9
...
Thread 0 crashed with X86 Thread State (64-bit):
  rax: 0x031dfff84803f501  rbx: 0x00007fd01fe71f00  rcx: 0x0080000000000001  rdx: 0x0100000000000000
  rdi: 0x00007fd01fe71f00  rsi: 0x021dfff84803f531  rbp: 0x00007ff7b77e0910  rsp: 0x00007ff7b77e08b0
   r8: 0x0000000000000010   r9: 0x0f0f0f0f0f0f0f0f  r10: 0x00007ff847952d38  r11: 0x00007ff807261c50
  r12: 0x00007ff7b77e0920  r13: 0x00007fd01fe71f00  r14: 0x00007ff7b77e0930  r15: 0x00007ff7b77e09b0
...
Binary Images:
    ...
    0x7ff808e31000 -     0x7ff809cc0fff com.apple.AppKit (6.9) <5dd484cf-ed6a-3633-b42e-6518aeecd5b9> /System/Library/Frameworks/AppKit.framework/Versions/C/AppKit
       0x10871b000 -        0x10a672fff com.redlemon.app (1.0.14) <9eb3cdb1-42d6-3772-b6b6-62ad7f2f8361> /Users/USER/Desktop/*/RedLemon.app/Contents/MacOS/RedLemon
       0x110d9a000 -        0x110e05fff dyld (*) <eea022bb-a6ab-3cd1-8ac1-54ce8cfd3333> /usr/lib/dyld
...
Writable regions: Total=166.1M written=0K(0%) resident=0K(0%) swapped_out=0K(0%) unallocated=166.1M(100%)
...
{"app_name":"RedLemon","timestamp":"2025-11-28 17:36:54.00 -0500","app_version":"1.0.14","slice_uuid":"9eb3cdb1-42d6-3772-b6b6-62ad7f2f8361","build_version":"14","platform":1,"bundleID":"com.redlemon.app","share_with_app_devs":0,"is_first_party":0,"bug_type":"309","os_version":"macOS 12.7.6 (21H1320)","incident_id":"F0223C73-3660-4635-A03D-A5FEF9282035","name":"RedLemon"}
{
  "uptime" : 9700,
  "procLaunch" : "2025-11-28 17:36:15.9163 -0500",
  "procRole" : "Foreground",
  "version" : 2,
  "userID" : 501,
  "deployVersion" : 210,
  "modelCode" : "MacBookPro12,1",
  "procStartAbsTime" : 9699062345401,
  "coalitionID" : 766,
  "osVersion" : {
    "train" : "macOS 12.7.6",
    "build" : "21H1320",
  ...
  "captureTime" : "2025-11-28 17:36:36.7335 -0500",
  "incident" : "F0223C73-3660-4635-A03D-A5FEF9282035",
  "bug_type" : "309",
  "pid" : 19190,
  "procExitAbsTime" : 9719717147903,
  "cpuType" : "X86-64",
  "procName" : "RedLemon",
  ...
  },
  {
    ...
    "size" : 32866304,
    "uuid" : "9eb3cdb1-42d6-3772-b6b6-62ad7f2f8361",
    "path" : "\/Users\/USER\/Desktop\/*\/RedLemon.app\/Contents\/MacOS\/RedLemon",
    "name" : "RedLemon",
    "CFBundleVersion" : "14"
  },
