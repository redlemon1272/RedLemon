...
Terminating Process:   exc handler [39164]
...
119 RedLemon                      	       0x101b49ae3 static RedLemonApp.$main() + 35 (RedLemonApp.swift:31)
120 RedLemon                      	       0x101b49b69 RedLemon_main + 9
121 dyld                          	       0x11402452e start + 462
...
1   RedLemon                      	       0x101918d09 @nonobjc kevent(_:_:_:_:_:_:) + 9
2   RedLemon                      	       0x101922c2f closure #1 in static KQueue.kevent(kq:changelist:nchanges:eventlist:nevents:timeout:) + 95 (System.swift:911)
3   RedLemon                      	       0x101923284 partial apply for closure #1 in static KQueue.kevent(kq:changelist:nchanges:eventlist:nevents:timeout:) + 36
4   RedLemon                      	       0x1019199bb syscall<A>(blocking:where:_:) + 395 (System.swift:247)
5   RedLemon                      	       0x101922b28 static KQueue.kevent(kq:changelist:nchanges:eventlist:nevents:timeout:) + 312 (System.swift:910)
6   RedLemon                      	       0x1018ff5f6 closure #1 in Selector.whenReady0(strategy:onLoopBegin:_:) + 230 (SelectorKqueue.swift:212)
7   RedLemon                      	       0x10190065f partial apply for closure #1 in Selector.whenReady0(strategy:onLoopBegin:_:) + 15
8   RedLemon                      	       0x1018f1523 Optional.withUnsafeOptionalPointer<A>(_:) + 467 (SelectorGeneric.swift:31)
9   RedLemon                      	       0x1018fde0d Selector.whenReady0(strategy:onLoopBegin:_:) + 1053 (SelectorKqueue.swift:211)
10  RedLemon                      	       0x1018f7734 Selector.whenReady(strategy:onLoopBegin:_:) + 100 (SelectorGeneric.swift:288)
11  RedLemon                      	       0x1018ebfee closure #2 in SelectableEventLoop.run() + 158 (SelectableEventLoop.swift:653)
12  RedLemon                      	       0x1018ef414 partial apply for closure #2 in SelectableEventLoop.run() + 20
13  RedLemon                      	       0x1018e3fa2 closure #1 in withAutoReleasePool<A>(_:) + 34 (SelectableEventLoop.swift:27)
14  RedLemon                      	       0x1018e3fec partial apply for closure #1 in withAutoReleasePool<A>(_:) + 28
15  libswiftObjectiveC.dylib      	    0x7ff82bc48e7c autoreleasepool<A>(invoking:) + 44
16  RedLemon                      	       0x1018e3f49 withAutoReleasePool<A>(_:) + 57 (SelectableEventLoop.swift:26)
17  RedLemon                      	       0x1018eb06f SelectableEventLoop.run() + 591 (SelectableEventLoop.swift:652)
18  RedLemon                      	       0x10188cd88 static MultiThreadedEventLoopGroup.runTheLoop(thread:parentGroup:canEventLoopBeShutdownIndividually:selectorFactory:initializer:_:) + 856 (MultiThreadedEventLoopGroup.swift:93)
19  RedLemon                      	       0x10188d4da closure #1 in static MultiThreadedEventLoopGroup.setupThreadAndEventLoop(name:parentGroup:selectorFactory:initializer:) + 282 (MultiThreadedEventLoopGroup.swift:111)
20  RedLemon                      	       0x1018937b3 partial apply for closure #1 in static MultiThreadedEventLoopGroup.setupThreadAndEventLoop(name:parentGroup:selectorFactory:initializer:) + 51
21  RedLemon                      	       0x10192367f thunk for @escaping @callee_guaranteed (@guaranteed NIOThread) -> () + 15
22  RedLemon                      	       0x1019261ef closure #1 in static ThreadOpsPosix.run(handle:args:detachThread:) + 1007 (ThreadPosix.swift:116)
23  RedLemon                      	       0x1019262a9 @objc closure #1 in static ThreadOpsPosix.run(handle:args:detachThread:) + 9
...
3   RedLemon                      	       0x101895c7f NIOThreadPool.process(identifier:) + 143 (NIOThreadPool.swift:186)
4   RedLemon                      	       0x101896b4e closure #3 in NIOThreadPool._start(threadNamePrefix:) + 222 (NIOThreadPool.swift:252)
5   RedLemon                      	       0x10192367f thunk for @escaping @callee_guaranteed (@guaranteed NIOThread) -> () + 15
6   RedLemon                      	       0x1019261ef closure #1 in static ThreadOpsPosix.run(handle:args:detachThread:) + 1007 (ThreadPosix.swift:116)
7   RedLemon                      	       0x1019262a9 @objc closure #1 in static ThreadOpsPosix.run(handle:args:detachThread:) + 9
...
Thread 0 crashed with X86 Thread State (64-bit):
  rax: 0x031dfff858953501  rbx: 0x00007f9605bbd200  rcx: 0x0080000000000000  rdx: 0x0100000000000000
  rdi: 0x00007f9605bbd200  rsi: 0x021dfff858953531  rbp: 0x00007ff7bf46a350  rsp: 0x00007ff7bf46a2f0
   r8: 0x0000000000000010   r9: 0x0f0f0f0f0f0f0f0f  r10: 0x00007ff858266d38  r11: 0x00007ff817b75c50
  r12: 0x00007ff7bf46a360  r13: 0x00007f9605bbd200  r14: 0x00007ff7bf46a370  r15: 0x00007ff7bf46a3f0
...
Binary Images:
    ...
    0x7ff819745000 -     0x7ff81a5d4fff com.apple.AppKit (6.9) <5dd484cf-ed6a-3633-b42e-6518aeecd5b9> /System/Library/Frameworks/AppKit.framework/Versions/C/AppKit
       0x100a90000 -        0x102a8ffff com.redlemon.app (1.0.14) <fb018b96-28b0-3b0c-95d8-ea64b92cf28d> /Users/USER/Desktop/*/RedLemon.app/Contents/MacOS/RedLemon
       0x11401f000 -        0x11408afff dyld (*) <eea022bb-a6ab-3cd1-8ac1-54ce8cfd3333> /usr/lib/dyld
...
{"app_name":"RedLemon","timestamp":"2025-12-07 19:26:08.00 -0500","app_version":"1.0.14","slice_uuid":"fb018b96-28b0-3b0c-95d8-ea64b92cf28d","build_version":"14","platform":1,"bundleID":"com.redlemon.app","share_with_app_devs":0,"is_first_party":0,"bug_type":"309","os_version":"macOS 12.7.6 (21H1320)","incident_id":"03C9B2C6-E6D8-459A-A10B-CD710EF1BF3C","name":"RedLemon"}
{
  "uptime" : 34000,
  "procLaunch" : "2025-12-07 19:26:02.8574 -0500",
  "procRole" : "Background",
  "version" : 2,
  "userID" : 501,
  "deployVersion" : 210,
  "modelCode" : "MacBookPro12,1",
  "procStartAbsTime" : 34820907157504,
  "coalitionID" : 626,
  "osVersion" : {
    "train" : "macOS 12.7.6",
    "build" : "21H1320",
  ...
  "captureTime" : "2025-12-07 19:26:05.0240 -0500",
  "incident" : "03C9B2C6-E6D8-459A-A10B-CD710EF1BF3C",
  "bug_type" : "309",
  "pid" : 39164,
  "procExitAbsTime" : 34823071260187,
  "cpuType" : "X86-64",
  "procName" : "RedLemon",
  ...
  },
  {
    ...
    "size" : 33554432,
    "uuid" : "fb018b96-28b0-3b0c-95d8-ea64b92cf28d",
    "path" : "\/Users\/USER\/Desktop\/*\/RedLemon.app\/Contents\/MacOS\/RedLemon",
    "name" : "RedLemon",
    "CFBundleVersion" : "14"
  },
