...
Terminating Process:   exc handler [38021]
...
119 RedLemon                      	       0x107451523 static RedLemonApp.$main() + 35 (RedLemonApp.swift:31)
120 RedLemon                      	       0x1074515a9 RedLemon_main + 9
121 dyld                          	       0x10e19152e start + 462
...
1   RedLemon                      	       0x107220749 @nonobjc kevent(_:_:_:_:_:_:) + 9
2   RedLemon                      	       0x10722a66f closure #1 in static KQueue.kevent(kq:changelist:nchanges:eventlist:nevents:timeout:) + 95 (System.swift:911)
3   RedLemon                      	       0x10722acc4 partial apply for closure #1 in static KQueue.kevent(kq:changelist:nchanges:eventlist:nevents:timeout:) + 36
4   RedLemon                      	       0x1072213fb syscall<A>(blocking:where:_:) + 395 (System.swift:247)
5   RedLemon                      	       0x10722a568 static KQueue.kevent(kq:changelist:nchanges:eventlist:nevents:timeout:) + 312 (System.swift:910)
6   RedLemon                      	       0x107207036 closure #1 in Selector.whenReady0(strategy:onLoopBegin:_:) + 230 (SelectorKqueue.swift:212)
7   RedLemon                      	       0x10720809f partial apply for closure #1 in Selector.whenReady0(strategy:onLoopBegin:_:) + 15
8   RedLemon                      	       0x1071f8f63 Optional.withUnsafeOptionalPointer<A>(_:) + 467 (SelectorGeneric.swift:31)
9   RedLemon                      	       0x10720584d Selector.whenReady0(strategy:onLoopBegin:_:) + 1053 (SelectorKqueue.swift:211)
10  RedLemon                      	       0x1071ff174 Selector.whenReady(strategy:onLoopBegin:_:) + 100 (SelectorGeneric.swift:288)
11  RedLemon                      	       0x1071f3a2e closure #2 in SelectableEventLoop.run() + 158 (SelectableEventLoop.swift:653)
12  RedLemon                      	       0x1071f6e54 partial apply for closure #2 in SelectableEventLoop.run() + 20
13  RedLemon                      	       0x1071eb9e2 closure #1 in withAutoReleasePool<A>(_:) + 34 (SelectableEventLoop.swift:27)
14  RedLemon                      	       0x1071eba2c partial apply for closure #1 in withAutoReleasePool<A>(_:) + 28
15  libswiftObjectiveC.dylib      	    0x7ff82bc48e7c autoreleasepool<A>(invoking:) + 44
16  RedLemon                      	       0x1071eb989 withAutoReleasePool<A>(_:) + 57 (SelectableEventLoop.swift:26)
17  RedLemon                      	       0x1071f2aaf SelectableEventLoop.run() + 591 (SelectableEventLoop.swift:652)
18  RedLemon                      	       0x1071947c8 static MultiThreadedEventLoopGroup.runTheLoop(thread:parentGroup:canEventLoopBeShutdownIndividually:selectorFactory:initializer:_:) + 856 (MultiThreadedEventLoopGroup.swift:93)
19  RedLemon                      	       0x107194f1a closure #1 in static MultiThreadedEventLoopGroup.setupThreadAndEventLoop(name:parentGroup:selectorFactory:initializer:) + 282 (MultiThreadedEventLoopGroup.swift:111)
20  RedLemon                      	       0x10719b1f3 partial apply for closure #1 in static MultiThreadedEventLoopGroup.setupThreadAndEventLoop(name:parentGroup:selectorFactory:initializer:) + 51
21  RedLemon                      	       0x10722b0bf thunk for @escaping @callee_guaranteed (@guaranteed NIOThread) -> () + 15
22  RedLemon                      	       0x10722dc2f closure #1 in static ThreadOpsPosix.run(handle:args:detachThread:) + 1007 (ThreadPosix.swift:116)
23  RedLemon                      	       0x10722dce9 @objc closure #1 in static ThreadOpsPosix.run(handle:args:detachThread:) + 9
...
3   RedLemon                      	       0x10719d6bf NIOThreadPool.process(identifier:) + 143 (NIOThreadPool.swift:186)
4   RedLemon                      	       0x10719e58e closure #3 in NIOThreadPool._start(threadNamePrefix:) + 222 (NIOThreadPool.swift:252)
5   RedLemon                      	       0x10722b0bf thunk for @escaping @callee_guaranteed (@guaranteed NIOThread) -> () + 15
6   RedLemon                      	       0x10722dc2f closure #1 in static ThreadOpsPosix.run(handle:args:detachThread:) + 1007 (ThreadPosix.swift:116)
7   RedLemon                      	       0x10722dce9 @objc closure #1 in static ThreadOpsPosix.run(handle:args:detachThread:) + 9
...
Thread 0 crashed with X86 Thread State (64-bit):
  rax: 0x031dfff858953501  rbx: 0x00007fb486ad3320  rcx: 0x0080000000000000  rdx: 0x0100000000000000
  rdi: 0x00007fb486ad3320  rsi: 0x021dfff858953531  rbp: 0x00007ff7b9b61350  rsp: 0x00007ff7b9b612f0
   r8: 0x0000000000000010   r9: 0x0f0f0f0f0f0f0f0f  r10: 0x00007ff858266d38  r11: 0x00007ff817b75c50
  r12: 0x00007ff7b9b61360  r13: 0x00007fb486ad3320  r14: 0x00007ff7b9b61370  r15: 0x00007ff7b9b613f0
...
Binary Images:
    ...
    0x7ff819745000 -     0x7ff81a5d4fff com.apple.AppKit (6.9) <5dd484cf-ed6a-3633-b42e-6518aeecd5b9> /System/Library/Frameworks/AppKit.framework/Versions/C/AppKit
       0x106399000 -        0x108394fff com.redlemon.app (1.0.14) <eaceee08-80cb-3d55-a546-306e0d86202c> /Users/USER/Desktop/*/RedLemon.app/Contents/MacOS/RedLemon
       0x10e18c000 -        0x10e1f7fff dyld (*) <eea022bb-a6ab-3cd1-8ac1-54ce8cfd3333> /usr/lib/dyld
...
Writable regions: Total=142.6M written=0K(0%) resident=0K(0%) swapped_out=0K(0%) unallocated=142.6M(100%)
...
{"app_name":"RedLemon","timestamp":"2025-12-07 19:14:09.00 -0500","app_version":"1.0.14","slice_uuid":"eaceee08-80cb-3d55-a546-306e0d86202c","build_version":"14","platform":1,"bundleID":"com.redlemon.app","share_with_app_devs":0,"is_first_party":0,"bug_type":"309","os_version":"macOS 12.7.6 (21H1320)","incident_id":"C9475A71-3A10-4ACA-B122-4BD116B260B2","name":"RedLemon"}
{
  "uptime" : 34000,
  "procLaunch" : "2025-12-07 19:14:04.4811 -0500",
  "procRole" : "Background",
  "version" : 2,
  "userID" : 501,
  "deployVersion" : 210,
  "modelCode" : "MacBookPro12,1",
  "procStartAbsTime" : 34102596767521,
  "coalitionID" : 626,
  "osVersion" : {
    "train" : "macOS 12.7.6",
    "build" : "21H1320",
  ...
  "captureTime" : "2025-12-07 19:14:06.1240 -0500",
  "incident" : "C9475A71-3A10-4ACA-B122-4BD116B260B2",
  "bug_type" : "309",
  "pid" : 38021,
  "procExitAbsTime" : 34104237016541,
  "cpuType" : "X86-64",
  "procName" : "RedLemon",
  ...
  },
  {
    ...
    "size" : 33538048,
    "uuid" : "eaceee08-80cb-3d55-a546-306e0d86202c",
    "path" : "\/Users\/USER\/Desktop\/*\/RedLemon.app\/Contents\/MacOS\/RedLemon",
    "name" : "RedLemon",
    "CFBundleVersion" : "14"
  },
